...
| 057 | Corregir Site URL de Supabase Auth — causa raíz de por qué un login de Google cancelado en `sonopolis.org` terminaba en `app-all-lemon.vercel.app` con `bad_oauth_state` y 404. Config del dashboard, sin código | Pendiente — acción manual en Supabase |
