...
| 089 | Entorno local: la base reconstruida desde migraciones, antes de tocar producción | Propuesto (16-sep-2026) — no hay runtime de contenedores en el Mac, así que toda migración se aplicó siempre directo a producción. OrbStack + `supabase db reset` (88 migraciones desde cero) + `supabase db lint`. **Bloquea a 090, 091, 092 y 093** |
