...
| 088 | La reserva pendiente caduca a los 30 minutos | Propuesto (16-sep-2026) — un `pending` ocupa aforo para siempre: 23 en producción, el más viejo del 4-sep. TTL de 30 min en el conteo de aforo, `expiration_date_to` en la preferencia de MP, y cancelación en `reconciliar-pagos` recién después de preguntarle a MP |
