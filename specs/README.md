...
| 082 | Cierre temporal obligatorio en `event_preventas`: `cierre_tipo` (`horas_antes`/`fecha`), `cierre_horas_antes`, `cierre_at`, con default recomendado `horas_antes`/3. Motivo: el 7-sep un fan compró en la puerta a precio de preventa — cupo y cierre manual no miran el reloj | **Escrito, sin aplicar** (8-sep-2026). Verificar antes de aplicar qué preventas activas hay: todas reciben el default de 3 h al agregar la columna |
